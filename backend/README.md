...
## Project Structure
    ...
    ├── testapiautocatalog_104188  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_104188`
...
2. Clone this repo and `cd testapiautocatalog_104188`
